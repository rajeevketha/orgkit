# OrgKit — Chrome Web Store submit checklist (v1.8.5)

## 1. Upload package (required)

- [ ] Upload **`OrgKit-1.8.5-store.zip`** (manifest at zip root — do **not** zip a parent folder)
- [ ] Confirm version **1.8.5**
...
- [ ] Load `OrgKit-1.8.5-store.zip` unpacked locally → Session connected on a Salesforce tab
