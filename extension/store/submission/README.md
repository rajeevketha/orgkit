# OrgKit Chrome Web Store submission pack (v1.8.3)

| Item | File |
|---|---|
| **Upload zip (this is what Chrome wants)** | `../releases/OrgKit-1.8.3-store.zip` |
...
- Upload **`OrgKit-1.8.3-store.zip`** only (manifest.json at the **root** of the zip).
